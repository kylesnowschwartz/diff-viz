...
// IcicleRendererV2 renders diff stats as a horizontal icicle/flame chart.
// Uses the D3-style separated layout/render architecture.
type IcicleRendererV2 struct {
	UseColor     bool
...
// NewIcicleRendererV2 creates an icicle renderer (v2 architecture).
func NewIcicleRendererV2(w io.Writer, useColor bool) *IcicleRendererV2 {
	style := DefaultBoxStyle()
	if !useColor {
		style = ASCIIBoxStyle()
	}
	return &IcicleRendererV2{
		UseColor:     useColor,
...
func (r *IcicleRendererV2) Render(stats *diff.DiffStats) {
...
func (r *IcicleRendererV2) buildTree(files []diff.FileStat) *TreeNode {
...
func (r *IcicleRendererV2) renderBorder(layout *Layout, levelIdx int, isTop bool) {
...
func (r *IcicleRendererV2) renderContentRow(layout *Layout, levelIdx int) {
...
func (r *IcicleRendererV2) renderSeparator(layout *Layout, aboveIdx, belowIdx int) {
...
func (r *IcicleRendererV2) renderLeafSeparator(layout *Layout, lastLevelIdx int, leaves []LayoutCell) {
...
func (r *IcicleRendererV2) renderStatsFooterFromCells(leaves []LayoutCell) {
	var sb strings.Builder
	sb.Grow(r.Width + 64)
	sb.WriteString(r.style.Vertical)
...
func (r *IcicleRendererV2) renderLeafBorder(leaves []LayoutCell) {
...
func (r *IcicleRendererV2) formatCentered(cell LayoutCell, width, reserveRight int) (content string, visualWidth int) {
...
func (r *IcicleRendererV2) truncate(s string, maxLen int) string {
	if maxLen <= 0 {
		return ""
	}
...
func (r *IcicleRendererV2) color(code string) string {
	if r.UseColor {
		return code
	}
	return ""
